...
@WebServlet("/DeleteReadexeciseController")
public class DeleteReadexeciseController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
  
    public DeleteReadexeciseController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DAO.ReadexeciseDAO.DeleteReadexecise(request, response, conn, readexeciseid);
