...
@WebServlet("/UploadfileExeclExamination")
public class UploadfileExeclExamination extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public UploadfileExeclExamination() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DAO.ExaminationDAO.importexcelExamination(request, response, conn, examinationid);
