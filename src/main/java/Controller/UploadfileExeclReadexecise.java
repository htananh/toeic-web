...
@WebServlet("/UploadfileExeclReadexecise")
public class UploadfileExeclReadexecise extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
    public UploadfileExeclReadexecise() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DAO.ReadexeciseDAO.importexcelReadexecise(request, response, conn, readexeciseid);
