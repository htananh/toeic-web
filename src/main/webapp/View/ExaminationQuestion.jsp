...
<title>Home Page</title><link rel="apple-touch-icon" sizes="180x180" href="template/assets/img/favicons/apple-touch-icon.png">
	...
	function auto_submit_timeout() {
		setTimeout("auto_submit()", 72000);
...
<body onload="auto_submit_timeout()">
	  <!-- ===============================================-->
    <!--    Main Content-->
    <!-- ===============================================-->
	 ...
	 <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="template/assets/img/gallery/logo-n.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="#">Pricing</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="#"></a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="#"></a></li>
            </ul>
      ...
      <section>
         ...
         <div class="container">
          <div class="row">
            <div class="col">
              <h6 class="font-sans-serif text-primary fw-bold"><div id="flipdown" class="flipdown"></div> </h6>
          ...
          <div id="paginationdemo" class="row">
            ...
            <div class="text-center mb-5"><span class="badge bg-black fw-normal text-uppercase bg-info">Trả Lời</span></div>
                <form  name="formSubmit" action="SubmitExamination?examinationid=<%=request.getAttribute("examinationid") %>" method="POST">
