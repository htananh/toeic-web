      	...
      	<% if(session.getAttribute("SSfullname") == null)
	{
	 ...
	 <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="template/assets/img/gallery/logo-n.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              <li class="nav-item px-2"><a class="nav-link active" aria-current="page" href="HomeFoward">Home</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="#">Pricing</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="#">Web Development</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="#">User Research</a></li>
            </ul>
          ...
          <div id="paginationdemo" class="row">
        	  ...
        	  <div id="p1" class="pagedemo _current" style="">
                  <div class="d-flex justify-content-start"><span class=" fw-medium">nhấn next để làm bài</span></div>
               	 ...
               	 <c:forEach var="list" items="${ListListenquestion}">
           		<div id="p${list.num}"  style="display:none;">
           			
            	 	<c:if test="${(list.imagename=='')}">
                  <div class="d-flex justify-content-start"><span class=" fw-medium"></span></div>
			         ...
			         <audio controls>
						  ...
						  <source src="fileListenexecise/${list.audiomp3}" type="audio/ogg">
                  ...
                  <div class="d-flex justify-content-start"><span class=" fw-medium"></span></div>
                  		...
                  		<h4>${list.num}</h4>
                  		<img src="fileListenexecise/${list.imagename}" alt="" class="rounded-circle" width="40" height="40">
			         <audio controls>
            ...
            <div class="text-center mb-5"><span class="badge bg-black fw-normal text-uppercase bg-info">Trả Lời</span></div>
                <form  name="formSubmit" action="SubmitListenexecise?listenexeciseid=<%=request.getAttribute("listenexeciseid") %>" method="POST">
             
             <c:forEach items="${ListListenquestion}" var="list">
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			${list.num}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
